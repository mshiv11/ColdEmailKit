...
export function RatingInput({
  ...
  return (
    <div
      className={cx(
        "flex items-center justify-between py-2 border-b last:border-0 gap-4",
        className,
      )}
    >
      ...
      <div className="flex gap-1 shrink-0">
        <button
          ...
          className={cx(
            ...
            value === true ? "bg-green-600 text-white" : "bg-muted hover:bg-muted/80",
          )}
        >
          Yes
        </button>
        <button
          ...
          className={cx(
            "px-3 py-1.5 rounded text-sm font-medium transition-colors",
            value === false ? "bg-red-600 text-white" : "bg-muted hover:bg-muted/80",
          )}
        >
          No
        </button>
