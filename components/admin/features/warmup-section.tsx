...
export function WarmupSection({ value, onChange, defaultOpen = false }: WarmupSectionProps) {
  ...
  const updateField = <K extends keyof WarmupFeatures>(field: K, newValue: WarmupFeatures[K]) => {
    ...
    >
      <div className="space-y-0">
        ...
        <SelectInput
          ...
          onChange={val =>
            updateField("warmupNetworkType", val as WarmupFeatures["warmupNetworkType"])
          }
