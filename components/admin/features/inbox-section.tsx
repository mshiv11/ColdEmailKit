...
export function InboxSection({ value, onChange, defaultOpen = false }: InboxSectionProps) {
  ...
  const updateField = <K extends keyof InboxFeatures>(field: K, newValue: InboxFeatures[K]) => {
  ...
  return (
    <CollapsibleSection
      ...
      description="Details about provided email inboxes"
      icon="lucide/inbox"
