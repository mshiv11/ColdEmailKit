...
export function PricingSection({ value, onChange, defaultOpen = false }: PricingSectionProps) {
  ...
  const updateField = <K extends keyof PricingSpecs>(field: K, newValue: PricingSpecs[K]) => {
  ...
  return (
    <CollapsibleSection
      ...
      filledCount={
        specs._notApplicable ? 0 : filledCount - (specs._notApplicable !== undefined ? 1 : 0)
      }
