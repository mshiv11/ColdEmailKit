...
export function LinkedInSection({ value, onChange, defaultOpen = false }: LinkedInSectionProps) {
  ...
  return (
    <CollapsibleSection
      ...
      description="LinkedIn automation and scraping"
        ...
        <SelectInput
          ...
          onChange={val =>
            updateField(
              ...
              val as LinkedInFeatures["linkedinConnectionMethod"],
            )
          }
