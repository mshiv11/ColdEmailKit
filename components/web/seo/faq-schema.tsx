 ...
 */
export function generateToolFAQs(
  toolName: string,
  options?: {
    pricing?: string | null
  ...
  return [
    {
      ...
      answer:
        "ColdEmailKit is a curated directory of the best cold email tools, helping you compare features, pricing, and reviews to find the perfect solutions for your outreach campaigns.",
    },
    {
      question: "How are tools ranked on ColdEmailKit?",
      answer:
        "Tools are ranked based on a combination of factors including user reviews, feature completeness, pricing value, deliverability rates, and overall popularity in the cold email community.",
    },
    {
      question: "Are the reviews on ColdEmailKit verified?",
      answer:
        "Yes, we aggregate and verify reviews from multiple trusted sources to provide accurate and reliable ratings for each tool.",
    },
    {
      question: "How often is ColdEmailKit updated?",
      answer:
        "We continuously update our listings with new tools, pricing changes, and feature updates to ensure you have the most current information available.",
    },
    {
      question: "Is ColdEmailKit free to use?",
      answer:
        "Yes, ColdEmailKit is completely free to browse. We help you discover and compare cold email tools at no cost.",
    },
  ]
}
