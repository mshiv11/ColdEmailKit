...
export function ToolFeaturesDisplay({
  ...
  const hasCopywriting =
    copywritingFeatures && hasAnyFeatures(parseFeatures(copywritingFeatures, {}))
  const hasOutreach = outreachFeatures && hasAnyFeatures(parseFeatures(outreachFeatures, {}))
  const hasDeliverability =
    deliverabilityFeatures && hasAnyFeatures(parseFeatures(deliverabilityFeatures, {}))
