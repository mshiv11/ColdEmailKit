...
export const specificationLabels: Record<
  keyof ToolSpecifications,
  { label: string; description: string }
> = {
  leadDatabaseAccess: {
    label: "Lead Database Access",
    description: "Built-in database for finding prospects",
  },
  emailFinding: { label: "Email Finding", description: "Ability to discover email addresses" },
  emailVerification: {
    label: "Email Verification",
    description: "Ability to validate email deliverability",
  },
  ...
  linkedinAutomation: {
    ...
    description: "Automates LinkedIn outreach actions",
  },
  multiStepSequences: {
    label: "Multi-step Sequences",
    description: "Automated follow-ups and sequences",
  },
...
export const pricingSpecsLabels: Record<
  keyof PricingSpecs,
  { label: string; description: string }
> = {
...
export const inboxFeaturesLabels: Record<
  keyof InboxFeatures,
  { label: string; description: string }
> = {
  _notApplicable: { label: "", description: "" },
  ...
  inboxHealthMonitoring: {
    label: "Inbox Health Monitoring",
    description: "Monitor inbox reputation",
  },
  inboxReplacementPolicy: { label: "Inbox Replacement Policy", description: "Replacement rules" },
  sendingPlatformCompatibility: {
    label: "Sending Platform Compatibility",
    description: "Supported sending tools",
  },
}
...
export const warmupFeaturesLabels: Record<
  keyof WarmupFeatures,
  { label: string; description: string }
> = {
  _notApplicable: { label: "", description: "" },
  ...
  autoReplyOpenSimulation: {
    label: "Auto Reply/Open Simulation",
    description: "Simulated engagement",
  },
...
export const leadsFeaturesLabels: Record<
  keyof LeadsFeatures,
  { label: string; description: string }
> = {
  _notApplicable: { label: "", description: "" },
...
export const enrichmentFeaturesLabels: Record<
  keyof EnrichmentFeatures,
  { label: string; description: string }
> = {
  _notApplicable: { label: "", description: "" },
  ...
  socialProfileEnrichment: {
    label: "Social Profile Enrichment",
    description: "LinkedIn, social links",
  },
...
export const copywritingFeaturesLabels: Record<
  keyof CopywritingFeatures,
  { label: string; description: string }
> = {
  _notApplicable: { label: "", description: "" },
...
export const outreachFeaturesLabels: Record<
  keyof OutreachFeatures,
  { label: string; description: string }
> = {
  _notApplicable: { label: "", description: "" },
...
export const deliverabilityFeaturesLabels: Record<
  keyof DeliverabilityFeatures,
  { label: string; description: string }
> = {
  _notApplicable: { label: "", description: "" },
  ...
  domainReputationMonitoring: {
    label: "Domain Reputation Monitoring",
    description: "Domain health tracking",
  },
  ...
  providerSpecificTesting: {
    label: "Provider-specific Testing",
    description: "Gmail, Outlook tests",
  },
...
export const linkedInFeaturesLabels: Record<
  keyof LinkedInFeatures,
  { label: string; description: string }
> = {
  _notApplicable: { label: "", description: "" },
  linkedinConnectionMethod: {
    label: "LinkedIn Connection Method",
    description: "Connection approach",
  },
  multipleLinkedinAccounts: {
    label: "Multiple LinkedIn Accounts",
  ...
  linkedinMessageSequences: {
    label: "LinkedIn Message Sequences",
    description: "Follow-up chains",
  },
  ...
  linkedinEmailSequences: {
    label: "LinkedIn + Email Sequences",
    description: "Cross-channel flows",
  },
}
