...
export function IntegrationForm({
  ...
  const form = useForm({
    ...
    defaultValues: {
      ...
      type: integration?.type ?? IntegrationType.Automation,
  ...
  // Watch form values for favicon generation
  const [slug, website] = form.watch(["slug", "website"])

  // Generate favicon
  const faviconAction = useServerAction(generateFavicon, {
    onSuccess: ({ data }) => {
      toast.success("Favicon successfully generated. Please save to update.")
