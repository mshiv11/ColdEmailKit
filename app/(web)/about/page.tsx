    ...
    <>
      ...
      <Prose>
        ...
        <p>
          ...
          navigating the cold email landscape. When I started sending cold emails in January 2025, I
          struggled with tool fatigue — there were dozens of platforms, each promising to be "the
        ...
        <p>
          ...
          representatives, agencies, and founders all faced the same problem — too many tools, not
          enough clarity.
        </p>
        ...
        <p>
          The growth exceeded my expectations. Within six weeks, we secured our first sponsor. Our
          no-nonsense approach to tool reviews resonated with the community, earning us a feature on
          Reddit and attracting attention from SDRs, agencies, and cold email experts across the
          industry.
        </p>
        ...
        <p>
          Whether you're a founder sending your first cold email or an agency managing campaigns at
          scale, we're here to simplify your tool selection process so you can focus on what
