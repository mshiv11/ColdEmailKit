            ...
            <Prose>
              <p>
                {compliance.description ||
                  `Browse our list of tools that adhere to the ${compliance.name} standard.`}
              </p>
              ...
              <Fragment key={tool.slug}>
                {(order - 1) % 5 === 0 && (
                  <Card hover={false} className="bg-yellow-500/10" asChild>
                    <Prose>
                      <p>
                        Looking for other compliant tools? Check out other standards in the{" "}
                        <Link href="/compliance">compliance directory</Link> and{" "}
